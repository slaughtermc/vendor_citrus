...
PRODUCT_COPY_FILES += \
    ...
    vendor/pixeldust/prebuilt/common/bin/50-base.sh:system/addon.d/50-base.sh \
...
PRODUCT_COPY_FILES += \
    ...
    vendor/pixeldust/config/permissions/privapp-permissions-pixeldust.xml:system/etc/permissions/privapp-permissions-pixeldust.xml \
