...
PRODUCT_COPY_FILES += \
    ...
    vendor/citrus/prebuilt/common/bin/50-base.sh:system/addon.d/50-base.sh \
...
# Some permissions
PRODUCT_COPY_FILES += \
    vendor/citrus/config/permissions/backup.xml:system/etc/sysconfig/backup.xml \
    vendor/citrus/config/permissions/privapp-permissions-citrus.xml:system/etc/permissions/privapp-permissions-citrus.xml \
    vendor/citrus/config/permissions/org.lineageos.snap.xml:system/etc/permissions/org.lineageos.snap.xml
...
PRODUCT_COPY_FILES += \
    vendor/citrus/prebuilt/common/lib/content-types.properties:system/lib/content-types.properties
...
# Power whitelist
PRODUCT_COPY_FILES += \
    vendor/citrus/config/permissions/custom-power-whitelist.xml:system/etc/sysconfig/custom-power-whitelist.xml
...
PRODUCT_ENFORCE_RRO_EXCLUDED_OVERLAYS += vendor/citrus/overlay
DEVICE_PACKAGE_OVERLAYS += vendor/citrus/overlay/common

# Key disabler package
PRODUCT_PACKAGES += \
    org.citrus.keydisabler

PRODUCT_BOOT_JARS += \
    org.citrus.keydisabler

# Branding
include vendor/citrus/config/branding.mk

# OTA
include vendor/citrus/config/ota.mk
