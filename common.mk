...
PRODUCT_COPY_FILES += \
    ...
    vendor/pixeldust/rebuilt/common/bin/50-base.sh:system/addon.d/50-base.sh \
    vendor/pixeldust/rebuilt/common/bin/blacklist:system/addon.d/blacklist

ifeq ($(AB_OTA_UPDATER),true)
PRODUCT_COPY_FILES += \
    vendor/pixeldust/rebuilt/common/bin/backuptool_ab.sh:system/bin/backuptool_ab.sh \
...
PRODUCT_COPY_FILES += \
    ...
    vendor/pixeldust/config/permissions/privapp-permissions-aosp.xml:system/etc/permissions/privapp-permissions-aosp.xml \
    vendor/pixeldust/config/permissions/org.lineageos.snap.xml:system/etc/permissions/org.lineageos.snap.xml
...
# userinit support
PRODUCT_COPY_FILES += \
    vendor/pixeldust/prebuilt/common/etc/init.d/90userinit:system/etc/init.d/90userinit
endif
...
# Power whitelist
PRODUCT_COPY_FILES += \
    vendor/pixeldust/config/permissions/custom-power-whitelist.xml:system/etc/sysconfig/custom-power-whitelist.xml
...
PRODUCT_PACKAGES += \
    org.pixeldust.keydisabler

PRODUCT_BOOT_JARS += \
    org.pixeldust.keydisabler

# Branding
include vendor/pixeldust/config/branding.mk

# OTA
include vendor/pixeldust/config/ota.mk
